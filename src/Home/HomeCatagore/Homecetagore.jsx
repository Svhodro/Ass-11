...
function Homecetagore() {
    ...
    return (
        <div className='flex justify-center items-center p-4 gap-4 flex-wrap'>
            <div className="card w-72 h-80 bg-base-100 shadow-xl" onClick={handleRelegion}>
            ...
            {/* 2nd card */}
            <div className="card w-72 h-80 bg-base-100 shadow-xl" onClick={handlebusiness}>
            ...
            {/* 3nd card */}
            <div className="card w-72 h-80 bg-base-100 shadow-xl" onClick={handleMystery}>
            ...
            {/* 4nd card */}
            <div className="card w-72 h-80 bg-base-100 shadow-xl" onClick={handleself}>
